...
st_lsp_status.segment = function(_, buffer)
...
st_lsp_status.current_function = function(_, buffer)
  if not buffer.lsp or not has_lsp_status then
    return ''
  end
...
st_lsp_status.server_progress = function(_, buffer)
  if not buffer.lsp or not has_lsp_status then
    return ''
  end
