...
---@return st.Item|function: Must be called to return an item
...
builtin.responsive_file = function(...)
  vim.notify "[status] lib.status.builtin.responsive_file is deprecated. Use builtin.make_responsive_file"
