...
M.change_theme = require "lib.tools.change_theme"
...
M.cmd = function(cmd, print_error)
  -- check if setup is running on windows and pipe the command through cmd.exe
...
M.list_themes = function()
  local default_themes = vim.fn.readdir(vim.fn.stdpath "config" .. "/lua/lib/colors/themes")
...
M.reload_theme = require "lib.tools.reload_theme"

-- update setup
M.update_setup = require "lib.tools.updater.update"

-- create snapshot
M.snap_create = require "lib.tools.updater.snap_create"

-- checkout snapshot
M.snap_checkout = require "lib.tools.updater.snap_checkout"

-- delete snapshot
M.snap_delete = require "lib.tools.updater.snap_delete"

M.write_data = function(old_data, new_data)
  local file_fn = require("lib.tools").file
  local file = fn.stdpath "config" .. "/lua/custom/" .. "setup.lua"
