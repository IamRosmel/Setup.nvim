...
M.update_url = M.current_config.options.repository.update_url or "https://github.com/IamRosmel/Setup.nvim"
M.update_branch = M.current_config.options.repository.update_branch or "main"
...
-- check if the Setup directory is a valid git repo
